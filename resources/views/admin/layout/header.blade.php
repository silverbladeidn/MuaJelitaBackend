        ...
        <nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
            <div class="container-fluid"> <!--begin::Start Navbar Links-->
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-md-block"> <a href="{{ asset('admin/user') }}" class="nav-link">Beranda</a> </li>
                ...
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                    ...
                    <li class="nav-item dropdown user-menu">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img src="<?php echo asset('assets/admin') ?>/dist/assets/img/jeje.jpg" class="user-image rounded-circle shadow" alt="User Image">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            ...
                            <li class="user-header text-bg-primary">
                                <img src="<?php echo asset('assets/admin') ?>/dist/assets/img/jeje.jpg" class="rounded-circle shadow" alt="User Image">
                                <p>
                                    {{ session('nama') }} - {{ session('akses_level') }}
                                    <small>Status: {{ session('status_user') }}</small>
                                </p>
